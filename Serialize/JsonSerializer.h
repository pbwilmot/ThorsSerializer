...
#define THOR_BUILD_SERIALIZE_CHAIN2(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN1(MACRO, MACRO_END, __VA_ARGS__)
#define THOR_BUILD_SERIALIZE_CHAIN3(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN2(MACRO, MACRO_END, __VA_ARGS__)
#define THOR_BUILD_SERIALIZE_CHAIN4(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN3(MACRO, MACRO_END, __VA_ARGS__)
#define THOR_BUILD_SERIALIZE_CHAIN5(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN4(MACRO, MACRO_END, __VA_ARGS__)
#define THOR_BUILD_SERIALIZE_CHAIN6(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN5(MACRO, MACRO_END, __VA_ARGS__)
#define THOR_BUILD_SERIALIZE_CHAIN7(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN6(MACRO, MACRO_END, __VA_ARGS__)
#define THOR_BUILD_SERIALIZE_CHAIN8(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN7(MACRO, MACRO_END, __VA_ARGS__)
#define THOR_BUILD_SERIALIZE_CHAIN9(MACRO, MACRO_END, _1, ...)      MACRO(_1) THOR_BUILD_SERIALIZE_CHAIN8(MACRO, MACRO_END, __VA_ARGS__)
